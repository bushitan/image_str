    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.OneToOneField(null=True, verbose_name='\u7236\u7c7b\u76ee\u5f55', to='wx_app.Category')),
            ],
            options={
                'verbose_name': '\u76ee\u5f55',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('category', models.ForeignKey(verbose_name='\u76ee\u5f55', to='wx_app.Category')),
                ('img', models.ForeignKey(verbose_name='\u56fe\u7247', to='wx_app.Img')),
            ],
            options={
                'verbose_name': '\u76ee\u5f55\u56fe\u7247\u5173\u7cfb',
        ...
        migrations.AddField(
            model_name='category',
            name='user_id',
            field=models.ForeignKey(verbose_name='\u76ee\u5f55', to='wx_app.User'),
        ),
    ]
